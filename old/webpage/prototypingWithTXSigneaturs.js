...
// var _strhexhex = P$.convertStringToHex(_str);
//
// console.log(_str +'\n'+_strhex+'\n'+_strhexhex);
//
// nLockTimeBuffer[0] = 3;
...
// hexstr = '0x'+hexstr;
// var _scriptOPpushString = 'OP_1 OP_2 OP_PUSHDATA1 4 '+ hexstr + ' OP_3\nOP_4';
// console.log(_scriptOPpushString);
// console.log(hexstr);
// var _scriptOpush = P$(_scriptOPpushString);
// console.log(_scriptOpush);
// var _result = bitcore.Script.Interpreter().debug(_scriptOPpushString,_scriptOPpushString);
// console.log(_result);
//
//
//
// var dataString = P$.convertStringToHex('Bitcoin Rocks');
// console.log(dataString);
// var dataStringBuffer = bitcore.util.buffer.hexToBuffer(dataString);
// console.log(dataStringBuffer); //12